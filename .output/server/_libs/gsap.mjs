...
var _lazySafeRender = function _lazySafeRender(
  animation,
  time,
  suppressEvents,
  force,
  ...
  animation.render(
    time,
    suppressEvents,
    force || !!(_reverting$1 && time < 0 && _isRevertWorthy(animation)),
  );
  _lazyTweens.length && !_reverting$1 && _lazyRender();
};
...
var _addLinkedListItem = function _addLinkedListItem(
  parent,
  child,
  firstProp,
  lastProp,
...
var _removeLinkedListItem = function _removeLinkedListItem(
  parent,
  child,
  firstProp,
  lastProp,
...
var _removeFromParent = function _removeFromParent(
  child,
...
var _rewindStartAt = function _rewindStartAt(
  tween,
  totalTime,
  suppressEvents,
  force,
...
var _parentToChildTotalTime = function _parentToChildTotalTime(
  parentTime,
  child,
) {
  return (
...
var _addToTimeline = function _addToTimeline(
  timeline,
  child,
  position,
  skipChecks,
...
var _attemptInitTween = function _attemptInitTween(
  tween,
  time,
  force,
  suppressEvents,
...
var _renderZeroDurationTween = function _renderZeroDurationTween(
  tween,
  totalTime,
  suppressEvents,
  force,
...
var _findNextPauseTween = function _findNextPauseTween(
  animation,
  prevTime,
  time,
) {
...
var _parsePosition$1 = function _parsePosition(
  animation,
  position,
  percentAnimation,
) {
...
var distribute = function distribute(v) {
  ...
  var vars = _isObject$1(v) ? v : { each: v },
...
var _getLabelInDirection = function _getLabelInDirection(
  timeline,
  fromTime,
  backward,
) {
...
var Timeline = /*#__PURE__*/ (function (_Animation) {
            ...
            child.render(
              child._ts > 0
                ...
                : (child._dirty ? child.totalDuration() : child._tDur) +
                    (adjustedTime - child._start) * child._ts,
              suppressEvents,
              force || (_reverting$1 && _isRevertWorthy(child)),
            );
            if (time !== this._time || (!this._ts && !prevPaused)) {
              pauseTween = 0;
              next &&
  ...
  _proto2.tweenFromTo = function tweenFromTo(fromPosition, toPosition, vars) {
    return this.tweenTo(
      toPosition,
      _setDefaults$1(
        { startAt: { time: _parsePosition$1(this, fromPosition) } },
        vars,
      ),
    );
  };
...
var _addPropTween = function _addPropTween(
  target,
  prop,
  start,
  end,
...
var _checkPlugin = function _checkPlugin(
  property,
  vars,
  tween,
  index,
...
var _updatePropTweens = function _updatePropTweens(
  tween,
  property,
  value,
  start,
...
var _parseFuncOrString = function _parseFuncOrString(
  value,
  tween,
  i,
  target,
...
var _setterFuncWithParam = function _setterFuncWithParam(
  target,
  property,
  value,
  data,
...
var _addPluginModifier = function _addPluginModifier(
  modifier,
  tween,
  target,
  property,
...
var _setterWithModifier = function _setterWithModifier(
  target,
  property,
  value,
  data,
...
var _renderCSSPropWithBeginning = function _renderCSSPropWithBeginning(
  ratio,
  data,
) {
  return data.set(
...
var _setterScaleWithRender = function _setterScaleWithRender(
  target,
  property,
  value,
  data,
...
var _setterTransformWithRender = function _setterTransformWithRender(
  target,
  property,
  value,
  data,
...
var _removeIndependentTransforms = function _removeIndependentTransforms(
  style,
) {
  if (style.translate) {
...
var _getComputedProperty = function _getComputedProperty(
  target,
  property,
  skipPrefixFallback,
) {
...
var _checkPropPrefix = function _checkPropPrefix(
  property,
  element,
  preferPrefix,
) {
...
var _getAttributeFallbacks = function _getAttributeFallbacks(
  target,
  attributesArray,
) {
...
var _addNonTweeningPT = function _addNonTweeningPT(
  plugin,
  target,
  property,
  beginning,
...
var _tweenComplexCSSString = function _tweenComplexCSSString(
  target,
  prop,
  start,
  end,
...
var _convertKeywordsToPercentages = function _convertKeywordsToPercentages(
  value,
) {
...
var _applySVGOrigin = function _applySVGOrigin(
  target,
  origin,
  originIsAbsolute,
  smooth,
...
var _addRotationalPropTween = function _addRotationalPropTween(
  plugin,
  target,
  property,
  startNum,
...
var _addRawTransformPTs = function _addRawTransformPTs(
  plugin,
  transforms,
  target,
) {
...
var _addListener$1 = function _addListener(
  element,
  type,
  func,
  passive,
...
var _getScrollFunc = function _getScrollFunc(element, _ref) {
  ...
  func.target = element;
  prev ||
    (func.smooth = gsap$1.getProperty(element, "scrollBehavior") === "smooth");
  return func;
};
var _getVelocityProp = function _getVelocityProp(
  value,
  minTimeRefresh,
  useDelta,
) {
...
var _createMarker = function _createMarker(
  type,
  name,
  container,
  direction,
...
var _positionMarker = function _positionMarker(
  marker,
  start,
  direction,
  flipped,
...
var _parsePosition = function _parsePosition(
  value,
  trigger,
  scrollerSize,
  direction,
...
var _interruptionTracker = function _interruptionTracker(
  getValueFunc,
  initialValue,
  onInterrupt,
) {
          ...
          if (
            ...
            var progress = (scroll - start) / change,
              ...
              velocity = refreshedRecently
                ? 0
                : ((totalProgress - snap2) / (_getTime() - _time2)) * 1e3 || 0,
  ...
  ScrollTrigger.enable = function enable() {
    ...
    if (gsap) {
      ...
      if (_body) {
        ...
        _doc.addEventListener("DOMContentLoaded", function onLoad() {
...
var _clampScrollAndGetDurationMultiplier =
  function _clampScrollAndGetDurationMultiplier(scrollFunc, current, end, max) {
...
//#endregion
export { gsapWithCSS as n, ScrollTrigger as t };
